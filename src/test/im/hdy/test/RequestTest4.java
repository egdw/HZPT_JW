...
public class RequestTest4 {
    ...
    public static void dl(String Url) {
        ...
        try {
            ...
            File file = new File("/Users/hdy/Downloads/");
            if (!file.exists()) {
                file.mkdirs();
            }

            fos = new FileOutputStream("/Users/hdy/Downloads/test.jpg");
            byte[] data = new byte[1024];
            int len = 0;
            while ((len = inputStream.read(data)) != -1) {
    ...
    public static void main(String[] args) {
        ...
        // 加密密码
        String Tmm = getMD5(id + getMD5(pwd).substring(0, 30).toUpperCase() + "13026").substring(0, 30).toUpperCase();
        System.out.println(Tmm);

        // 获取验证码
        String Url = "http://jw.hzpt.edu.cn/sys/ValidateCode.aspx";
        RequestTest4.dl(Url);
        ...
        // String yz ="w2dt";
        // 加密验证码
        String yzm = getMD5(getMD5(yz.toUpperCase()).substring(0, 30).toUpperCase() + "13026").substring(0, 30)
                .toUpperCase();
        ...
        String result = RequestTest4.sendHttpClientPost(path, map, encode, set_cookie1);
